    ...
    "newObjectForm": function () {
        ...
        return {
            ...
            onSubmit: function (values) {
                ...
                console.log(1);
//                Meteor.call('abc', self.application.name, {
//                    'application': object
...
Template.ApplicationsDetailsFormViewForm.events({
    ...
    "click .object-array-table tr": function (e, t) {
        e.preventDefault();
        Router.go("applications.details.form_view", {
            applicationId: this.rootId,
