...
Template.UserSettingsChangePassword.rendered = function() {
	
	$("input[autofocus]").focus();
};

Template.UserSettingsChangePassword.created = function() {
	pageSession.set("errorMessage", "");	
	pageSession.set("infoMessage", "");	
};

Template.UserSettingsChangePassword.events({
...
Template.UserSettingsChangePassword.helpers({
